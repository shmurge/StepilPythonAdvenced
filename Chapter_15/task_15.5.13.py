...
def is_correct_digit(digit):
    return len(str(abs(digit))) == 2 and (digit % 7 == 0)
...
filtered_nums = filter(is_correct_digit, numbers)
squares_sum = sum(map(square, filtered_nums))
print(squares_sum)
